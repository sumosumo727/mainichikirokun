...
import { Calendar, BookOpen, BarChart3, LogOut, User, Activity } from 'lucide-react';
import { useAuthStore } from '../../store/authStore';

interface HeaderProps {
  currentView: 'calendar' | 'books' | 'stats' | 'health';
  onViewChange: (view: 'calendar' | 'books' | 'stats' | 'health') => void;
}
